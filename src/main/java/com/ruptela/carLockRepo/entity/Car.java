...
public class Car implements Serializable {
    ...
    public static Car from(String make, String model, String vin, String plateNb) {
        return new Car(vin, make, model, plateNb, true);
    }

    public static Car from(CarDTO p) {
        return new Car(p.getVin(), p.getMake(), p.getModel(), p.getPlateNb(), true);
    }
